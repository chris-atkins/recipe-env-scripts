...
def create_new_server(server_name, server_size):
    post_data={"name":server_name,"region":"nyc3","size":server_size,"image":"docker-20-04","ssh_keys":["1734160"],"backups":False,"ipv6":False,"user_data":None,"private_networking":None}
